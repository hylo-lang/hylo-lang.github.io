...
While we embrace tools that improve efficiency, we must avoid committing code we do not understand. If you include LLM-generated code that is complex or opaque to you:

- Flag it explicitly with an inline code comment.
- Alert reviewers so they can apply extra scrutiny.

Ultimately, you are responsible for the code you commit. Ensure you review and test generated thoroughly.
